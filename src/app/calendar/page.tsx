...
const mockApplications: RentalApplication[] = [
  ...
  },
  {
    ...
    viewingDate: new Date("2024-01-20T10:30:00"),
    viewer: "John",
  ...
  },
  {
    ...
    viewingDate: new Date("2024-01-25T16:00:00"),
    viewer: "John & Sarah",
    notes: "Expensive but amazing views.",
    status: "applied",
  },
];
...
export default function CalendarPage() {
  ...
  const events: CalendarEvent[] = mockApplications
    .filter((app) => app.viewingDate)
    .map((app) => ({
      id: app.id,
      title: `Viewing: ${app.name}`,
      date: app.viewingDate!,
